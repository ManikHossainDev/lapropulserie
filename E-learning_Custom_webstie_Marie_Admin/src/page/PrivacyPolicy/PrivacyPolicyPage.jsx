...
import { useGetPrivacyPolicyQuery } from "../../redux/features/setting/getAllData";
  ...
  return (
    <section className="w-full h-full min-h-screen">
      <div className="flex justify-between items-center py-5">
        ...
        <Link to={'/edit-privacy-policy'}>
          <button className="bg-[#2d2a71] text-white flex items-center gap-2 p-2 rounded-md font-bold" border>
