...
const PrivacyTab = () => {
    ...
    if (isLoading) {
        return (
            <div className="bg-gray-50 rounded-2xl p-6">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Politique de confidentialité</h2>
    ...
    if (isError) {
        return (
            <div className="bg-gray-50 rounded-2xl p-6">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Politique de confidentialité</h2>
                <p className="text-sm text-red-400">Impossible de charger la politique de confidentialité.</p>
            </div>
        );
    }
