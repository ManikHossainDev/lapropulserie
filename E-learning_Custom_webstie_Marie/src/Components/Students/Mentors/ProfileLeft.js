...
import { openMentorFreeIntro } from './bookMentorSession';
    ...
    <div className="space-y-5">
      <div className="bg-white/90 backdrop-blur rounded-2xl p-6 shadow border text-center top-6">
        ...
        <button
          ...
          className="w-full customSignUpButton text-white py-4 rounded-lg font-medium mt-4 hover:bg-indigo-900"
        >
        ...
        <button
          type="button"
          className="w-full cursor-pointer border py-3 rounded-lg mt-3 text-gray-700 hover:bg-gray-50"
        >
          Ajouter aux favoris
        </button>
      </div>
