...
export const createWithdrawalRequestValidationSchema = z.object({
  body: z.object({
    bankAccountNumber: z
      .string({
      ...
      .min(2, {
        message: 'bankAccountNumber must be at least 5 characters long',
      }),
    ...
    bankRoutingNumber: z
      ...
      .min(2, {
        message: 'bankRoutingNumber must be at least 5 characters long',
      }),
    ...
    bankAccountHolderName: z
      ...
      .min(2, {
        message: 'bankAccountHolderName must be at least 2 characters long',
      }),

    bankAccountType: z.enum(['savings', 'current'], {
      required_error: 'bankAccountType is required',
      invalid_type_error:
        'bankAccountType must be either "savings" or "current"',
    }),
  ...
  params: z.object({
    id: z
      ...
      .refine(value => mongoose.Types.ObjectId.isValid(value), {
        message:
          'withdrawalRequestId must be a valid mongoose ObjectId in params.',
      }),
  }),
  // query: z.object({
  //   page: z.string().optional(),
