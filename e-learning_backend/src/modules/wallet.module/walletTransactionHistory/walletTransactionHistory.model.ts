...
const WalletTransactionHistorySchema = new Schema<IWalletTransactionHistory>(
  {
     ...
     * 
     * But For WithdrawalRequest we dont need this 
    ...
    referenceFor: {
      ...
      enum: [
        ...
        TTransactionFor.PurchasedIndividualCapsule,  // for paymentTransactionId
        TTransactionFor.WithdrawalRequest,  // for creating WalletTransactionHistory | admin end
      ],
